Boom.RiflePowerup = function( params ){
...
Boom.RiflePowerup.prototype = Boom.inherit(Boom.Entity, {
  ...
  init: function() {
    ...
    var physics = new Boom.PhysicalComponent(
       {
        name:'powerup_item_rifle_physics',
    ...
    var animation = new Boom.AnimationComponent( 
      {
        name: "powerup_item_rifle_animation",
    ...
    var animation_disappear = new Boom.AnimationComponent( 
      {
        name: "powerup_item_rifle_animation_disappear",
        object: physics.object,
  ...
  dispose: function(){
    ...
    this.components.powerup_item_rifle_animation_disappear.animate();
    //Call super    
    window.setTimeout(function( entity ){ 
      Boom.Entity.prototype.dispose.call(entity);
    }, 
    this.components.powerup_item_rifle_animation_disappear.ms, this);
  },
