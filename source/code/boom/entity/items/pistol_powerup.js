...
Boom.PistolPowerup.prototype = Boom.inherit(Boom.Entity, {
  ...
  init: function() {
    ...
    var animation_disappear = new Boom.AnimationComponent( 
      {
        name: "powerup_item_pistol_animation_disappear",
        object: physics.object,
  ...
  dispose: function(){
    ...
    this.components.powerup_item_pistol_animation_disappear.animate();
    //Call super    
    window.setTimeout(function( entity ){ 
      Boom.Entity.prototype.dispose.call(entity);
    }, 
    this.components.powerup_item_pistol_animation_disappear.ms, this);
  }
});
