Boom.RocketPowerup = function( params ){
  ...
  this.message = new Boom.Message({ receiver: Boom.Constants.Component.TYPE.INVENTORY, data: {name: Boom.Constants.Ammunition.ROCKET, value: this.value}, type: Boom.Constants.Message.Action.INCREASE_AMMO, sender: this.type });

  Boom.Entity.call(this, {name: 'POWERUP_ITEM_ROCKETS', is_singular: true});
};

Boom.RocketPowerup.prototype = Boom.inherit(Boom.Entity, {
  constructor: Boom.RocketPowerup,
  ...
  init: function() {
    ...
    var physics = new Boom.PhysicalComponent(
       {
        name:'powerup_item_rocket_physics',
    ...
    var animation = new Boom.AnimationComponent( 
      {
        name: "powerup_item_rocket_animation",
    ...
    var animation_disappear = new Boom.AnimationComponent( 
      {
        name: "powerup_item_rocket_animation_disappear",
        object: physics.object,
    ...
    var audio = new Boom.AudioComponent(
      {
        name: 'ROCKET_AUDIO',
        sound: Boom.Assets.sounds.items.rocket_powerup,
        owner: this
      }
    );
  ...
  dispose: function(){
    this.components.ROCKET_AUDIO.play();

    this.components.powerup_item_rocket_animation_disappear.animate();
    //Call super    
    window.setTimeout(function( entity ){ 
      Boom.Entity.prototype.dispose.call(entity);
    }, 
    this.components.powerup_item_rocket_animation_disappear.ms, this);
  },
